...
|:---|:---|:---|
|DetectGPT: Zero-Shot Machine-Generated Text Detection|A foundational paper exploring how text generated by an LLM tends to occupy negative curvature regions of the model's log probability function.|background_reading/2301.11305v2.pdf|
|A linguistic comparison between human and AI-generated content|A conceptual breakdown of features that distinguish human and AI generated text grammatically.|background_reading/main.pdf|
|The False Positive Problem in AI Detection|An article highlighting the ethical and practical issues when AI detectors incorrectly flag human authors, particularly non-native English speakers.|background_reading/2304.02819v3.pdf|
|A Watermark for Large Language Models|Research on how AI companies are attempting to embed statistical "watermarks" into model outputs, and how detectors look for them.|background_reading/2301.10226v4.pdf|
|What Distinguishes AI-Generated from Human Writing? A Rapid Review of the Literature|A quick overview of several potential features distinguishing AI writing, concluding that there is no 'signature' AI mark.|background_reading/BDCC-10-00055.pdf|
